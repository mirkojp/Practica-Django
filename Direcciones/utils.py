...
# from .models import Provincia, Direccion
...
# ):
#     """
#     Intenta obtener una Direccion de la base de datos por su calle y número.
#     Si no existe, crea la Direccion en la base de datos, asegurándose
#     de que la ciudad y la provincia correspondientes existan.

#     Args:
#         calle (str): La calle de la Direccion.
#         numero (int): El número de la Direccion.
#         contacto (str): El número de contacto.
#         email (str): La Direccion de correo electrónico.
#         codigo_postal (str): El código postal de la Direccion.
#         id_ciudad (int): El ID de la ciudad donde se encuentra la Direccion.
#         id_provincia (int): El ID de la provincia donde se encuentra la ciudad.

#     Returns:
#         Direccion: La instancia de la Direccion obtenida o creada.
#     """
#     try:
#         return Direccion.objects.get(calle=calle, numero=numero, ciudad_id=id_ciudad)
#     except Direccion.DoesNotExist:
#         # Si no existe, crear la Direccion en la base de datos
